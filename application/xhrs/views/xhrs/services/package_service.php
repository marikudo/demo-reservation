...
<input type="hidden" id="services_id" value="<?=$user['permission']['room_type_id']?>"/>
...
<table class="table table-custom display" style="font: 12px 'Arial';" id="table">
    <thead>
      <tr>
        ...
        <th class="align-center">Services Name</th>
...
$(document).ready(function(){
   ...
   var oTable =  $('#table').dataTable({
    ...
    "aoColumns":[
                ...
                {"bSearchable":true,"mData":"service_name","sWidth":"660px"},
